...
@section('content')
    <div class="main-content">
        ...
        <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center"
            style="min-height: 600px; background-image: url({{ asset('storage/' . $user->cover) }}); background-size: cover; background-position: center top;">
            <!-- Mask -->
            ...
            <div class="container-fluid d-flex align-items-center">
                <div class="row">
                    <div class="col-lg-7 col-md-10">
                        ...
                        <a href="/profile/{{ $user->username }}/edit" class="btn btn-info">Edit profile</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="text-center">
                                <h3>
                                    {{ auth()->user()->name }}<span class="font-weight-light">,
                                        {{ \Carbon\Carbon::parse(auth()->user()->birthday)->diff(\Carbon\Carbon::now())->format('%y') }}</span>
                                </h3>
